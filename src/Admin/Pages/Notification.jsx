...
const Notification = () => {
  ...
  const itemsPerPage = 8; // Set your preferred number of items per page
  ...
  // Memoized filtered, searched & sorted sellers for performance
  ...
  return (
    <Box sx={{ paddingX: 5, paddingY: 2 }}>
      ...
      {/* Sellers Grid */}
      <Notificationlist notifications={paginatedSellers} />
